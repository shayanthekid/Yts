                    ...
                    <div ref={headingRef} className="w-5/6 md:w-5/6 lg:w-4/12 px-1 md:px-3 mr-auto ml-auto -mt-78">
                        <div className="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-[#CCE28D]">
                            ...
                            <blockquote className="relative p-8 mb-4">
                                ...
                                <p className="text-md  text-left md:text-center lg:text-center font-normal mt-2 text-black text-lg">
                                    Nearly two decades ago, Murtaza Mansoor left home in Sri Lanka at the age of 19 to go on a quest to seek his passion. After considering migration in 3 different countries, he finally found settlement in the United States of America. He began his journey working as a delivery partner for Kristal Graphics, a printing company. Over there, he discovered his passion for printing and worked hard to earn a promotion as an official sales personnel at the same firm. Murtaza worked for 7 years in sales, through this period he also found his life partner in the US. After years of hard work in the field of printing at Kristal Graphics, Murtaza was rewarded for his unwavering spirit and dedication towards the printing business.
                            ...
                            <div className="w-full md:w-6/12 px-4">
                                <div className="relative flex flex-col mt-4">
                                    <div className="px-4 py-5 flex-auto">
                                        ...
                                        <h6 className="text-xl mb-1 font-semibold">YTS Investments
</h6>
                            ...
                            <div className="w-full md:w-6/12 px-4">
                                <div className="relative flex flex-col min-w-0 mt-4">
                                    <div className="px-4 py-5 flex-auto">
                                        ...
                                        <h6 className="text-xl mb-1 font-semibold">Automobile </h6>
                                        <p className="mb-4 text-blueGray-500">
                                ...
                                <div className="relative flex flex-col min-w-0">
                                    <div className="px-4 py-5 flex-auto">
                                        ...
                                        <h6 className="text-xl mb-1 font-semibold">Real Estate</h6>
                                        <p className="mb-4 text-blueGray-500">
