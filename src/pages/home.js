          ...
          {isDesktop ? (
              ...
              <div className="container mx-auto p-2 z-50">
                  ...
                  <div className="grid grid-rows-1 md:grid-cols-2 gap-4">
                      {/* Card - Left Column */}
                      <div className="p-4 h-[350px] z-10 -ml-6 -mt-20" ref={headingRefDesk}> {/* Set a fixed height */}
                      ...
                      <div className="flex flex-row items-center justify-center z-10 -mt-32 -mr-20" >
                          {/* Blue Section */}
